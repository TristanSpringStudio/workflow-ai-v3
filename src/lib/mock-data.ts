...
export const tasks: Task[] = [
  ...
  // ─── Additional tasks to fill out the map ───
  {
    ...
    painPoints: ["Takes a full afternoon"], isBottleneck: false, tags: ["content", "planning"], lastUpdated: "2026-03-15T10:00:00Z", addedBy: "c1",
  },
  {
    ...
    painPoints: ["Manual scoring is inconsistent"], isBottleneck: false, tags: ["leads", "qualification"], lastUpdated: "2026-03-15T10:00:00Z", addedBy: "c1",
  },
  {
    ...
    painPoints: ["Pulling from 5 different reports", "Numbers are always stale by the time they're compiled"], isBottleneck: false, tags: ["sales", "forecasting"], lastUpdated: "2026-03-16T14:00:00Z", addedBy: "c2",
  },
  {
    ...
    painPoints: ["3 hours of meetings every week", "CRM updates happen after meetings, not during"], isBottleneck: false, tags: ["sales", "pipeline", "meetings"], lastUpdated: "2026-03-16T14:00:00Z", addedBy: "c2",
  },
  {
    ...
    painPoints: ["Manual data entry", "Chasing down approvals"], isBottleneck: false, tags: ["finance", "invoices"], lastUpdated: "2026-03-20T10:00:00Z", addedBy: "c6",
  },
  {
    ...
    painPoints: ["Context switching between reviews and coding", "No automated quality checks"], isBottleneck: false, tags: ["engineering", "code-review"], lastUpdated: "2026-03-18T11:00:00Z", addedBy: "c4",
  },
  {
  ...
  },
  {
    ...
    painPoints: ["Chasing missing receipts", "Manual data entry"], isBottleneck: false, tags: ["finance", "expenses"], lastUpdated: "2026-03-20T10:00:00Z", addedBy: "c6",
  },
  {
    ...
    painPoints: ["Manual data compilation", "By the time we flag it, it's often too late"], isBottleneck: false, tags: ["operations", "client-success"], lastUpdated: "2026-03-17T09:00:00Z", addedBy: "c3",
  },
];
